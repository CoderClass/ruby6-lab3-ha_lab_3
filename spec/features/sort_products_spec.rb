...
RSpec.feature "SortProducts", type: :feature do
  ...
  scenario "visit clicks on Sort by Alphabetical" do
    ...
    product2 = FactoryGirl.create(:product, name: "Adam's Hat") # create another product with "Adam's Hat" name
    ...
    expect(current_url).to eq root_url(sort: "alphabetical") # make sure your link submits to the correct URL
